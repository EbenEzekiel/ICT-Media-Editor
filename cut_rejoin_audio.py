...
def cut_and_join_audio(input_video, segments, output_audio):
    """
    ...
    try:
        ...
        # Export final video
        final_audio.write_videofile(output_audio)
...
if __name__ == "__main__":
    ...
    cut_and_join_audio(input_file, segments_to_keep, output_file)
